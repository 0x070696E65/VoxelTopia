...
public class VoxelState {
    ...
    public Vector3Int globalPosition => new(position.x + chunkData.position.x, position.y, position.z + chunkData.position.y);
...
public class VoxelNeighbours {
    ...
    public void Reset()
    {
        ...
        for (var i = 0; i < 6; i++)
        {
            this[i].neighbours.Reset();
            this[i] = null;
        }
        neighbours = null;
        parent.neighbours.Reset();
        parent = null;
    }
    public int Length => neighbours.Length;
    ...
    public VoxelState this[int index] {
        ...
        get {
            ...
            if (neighbours[index] == null) {
                ...
                neighbours[index] = World.Instance.worldData.GetVoxel(parent.globalPosition + VoxelData.faceChecks[index]);
    ...
    void ReturnNeighbour (int index) {
        ...
        if (neighbours[index] == null || neighbours == null)
            return;
