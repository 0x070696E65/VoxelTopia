...
public class VertData {
    ...
    public Vector3 GetRotatedPosition (Vector3 angles) {
        ...
        var centre = new Vector3(0.5f, 0.5f, 0.5f); // The centre of the block that we are pivoting around.
        var direction = position - centre; // Get the direction from the centre to the current vertice.
